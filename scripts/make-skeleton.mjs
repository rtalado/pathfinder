...
De app kan je voortgang en je eigen leerpaden gelijk houden tussen je computer en je telefoon. Dat gaat via een eigen privé repository op GitHub: er is geen andere dienst bij betrokken en je gegevens blijven van jou.

## Wat je nodig hebt

1. Een GitHub-account.
2. Een **privé** repository, bijvoorbeeld met de naam learnpath.
